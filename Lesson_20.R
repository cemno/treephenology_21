...
# plotting
plot_PLS(plscf, PLS_results_path= "data/PLS_outputs")

# adding a running mean
...
plot_PLS(plscf,
         PLS_results_path= "data/PLS_outputs",
         add_chill = c(-48,62),
         add_heat = c(-5,105.5))
...
# making a function out of all this
...
# with this function, we can now easily do the whole analysis for another model
# e.g. chilling hours
daychill<-daily_chill(hourtemps=temps_hourly,
                      running_mean=11,
                      models = list(Chilling_Hours = Chilling_Hours, Utah_Chill_Units = Utah_Model,
