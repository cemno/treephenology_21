# effective temperature ranges for various models
...
# Let's summarize winter temperatures at locations we've worked with
...
# combining model sensitivity and location temperatures into 1 plot
